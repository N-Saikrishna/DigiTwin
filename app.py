...
def dashboard():
    try:
        ...
        # --- Logic for the Paragraph Advisory Note ---
        recommendations = prediction_data.get("recommendations", [])
        
        # If it's a list, join it. If it's a string, use it as is.
        if isinstance(recommendations, list):
            full_advice = " ".join(recommendations)
        else:
            full_advice = str(recommendations)
